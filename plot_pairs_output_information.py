...
def plot_2d(x,y,w,name,xlabel,ylabel,bins,limits):
...
plot_log(x, w, 'Combi_HNL_mom_log','Reconstructed HNL Momentum (GeV/c)',0.1,500.,35)
...
w = pair_information[:,0]
plot_2d(x, y, w, 'Combi_Vertex_xy','Vertex X Coordinate (cm)','Vertex Y Coordinate (cm)',50,[[-1500,1500],[-1500,1500]])

print('Vertex z:y')
x = pair_information[:,14]
y = pair_information[:,13]
w = pair_information[:,0]
plot_2d(x, y, w, 'Combi_Vertex_zy','Vertex Z Coordinate (cm)','Vertex Y Coordinate (cm)',50,[[-5000,5000],[-1500,1500]])
